...
$cfg_smsprovider = "kapsys";

$cfg_smshandler_param = array(
...
// SMTP Configuration
$cfg_mail_Host = 'smtp.gmail.com';
$cfg_mail_Mailer = 'smtp';
$cfg_smtp_username = 'apps@akshara.org.in';
$cfg_smtp_password = 'ebja mqhz yyxc vvts';
$cfg_smtp_Sender = 'apps@akshara.org.in';
$cfg_htmlformat = true;
// $cfg_sendmail_path = '/usr/sbin/sendmail';
