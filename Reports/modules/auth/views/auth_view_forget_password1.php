...
?>
    ...
    <head>
      ...
      <?php
      // include($_SESSION['EMRP_BASE_DIR'] . "/app/views/includes/library_header.php");

      ?>
    </head>

    <body class="login">
      <form action="<?php echo $_SESSION['EMRP_BASE_DIR'] . 'modules/auth/auth_controller.php'; ?>" method="post" name="forgot_password" id="forgot_password">
          ...
          <div style="width:320px; height:100%; border:0px solid red;">
            <div class="login_bg">
              ...
              <div class="login_logo">
                <img src="<?php echo $_SESSION['EMRP_BASE_DIR'] . 'app/views/css/blueTheme/login/log_logo.gif'; ?>" width="100" height="40" border="0" />
              </div>
                        ...
                        <table>
                          <tr>
                            <td>
                              ...
                              <?php
                              $cancelURL = $_SESSION['EMRP_BASE_DIR'] . 'modules/auth/auth_controller.php?taskname=show_login';
                              ?>
