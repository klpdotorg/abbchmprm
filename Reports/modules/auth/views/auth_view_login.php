...
?>
        ...
        <body>
            <div style="background-image:url(&quot;<?php global $_app_bootstrapdir_url;
                                                    echo $_app_bootstrapdir_url; ?>/assets/img/homescr_bg.png&quot;);height:650px;background-position:center;background-size:cover;background-repeat:no-repeat;">
                <div class="d-flex justify-content-center align-items-center" style="height:inherit;min-height:initial;width:100%;position:absolute;left:0;background-color:rgba(30,41,99,0.53);">
                    <div data-aos="fade-down" data-aos-duration="1000" data-aos-delay="100" data-aos-once="true" class="login-card" style="font-family:Roboto, sans-serif;">
                        ...
                        <!-- MESSAGE DISPLAY BLOCK START -->
                        <?php if (!empty($arrErrorMsg)) { ?>
                            <div class="text-center mb-3">
                                <?php foreach ($arrErrorMsg as $msg) { ?>
                        ...
                        <form class="form-signin" action="<?php global $cfg_authcontroller;
                                                            $_SESSION['EMRP_BASE_URL'] . $cfg_authcontroller; ?>" method="post">
                        ...
                        <p class="text-center"
                            ...
                            <a href="<?php
                                        ...
                                        echo $_SESSION['EMRP_BASE_URL'] . $cfg_authcontroller . '?taskname=show_forgot_password';
                                        ?>">
                                Reset Password
                            </a>
                            <a href="<?php echo $_SESSION['EMRP_BASE_URL']; ?>emrpresetpassword?taskname=show_forgot_password">
                                Reset Password
                            </a>
