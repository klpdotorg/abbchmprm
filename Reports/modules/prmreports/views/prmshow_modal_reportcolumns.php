		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				foreach ($args['arrAllwhereclause'] as $checkMaster) {
					...
					if (isset($arrMaster[$checkMaster['report_whereclause_column_name']])) {
					...
					<table>
						...
						foreach ($args['arrAllwhereclause'] as $allWhereclause) { ?>
							<tr>
								...
								if (isset($arrMasterSelect[$reccnt]) && is_array($arrMasterSelect[$reccnt]) && sizeof($arrMasterSelect[$reccnt]) > 0) {
								?>
									<td style="width: 30%;">
								...
								<?php } else if ($allWhereclause['wc_datatype'] == 'varchar') { ?>
								...
								<?php } else if ($allWhereclause['wc_datatype'] == 'datetime') { ?>
								...
								<?php } else if ($allWhereclause['wc_datatype'] == 'integer') { ?>
