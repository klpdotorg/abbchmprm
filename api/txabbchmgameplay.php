    ...
    foreach ($jsondata_array as $data) {
        ...
        if ($data) {
            ...
            if (!$childexists) {
                ...
                $em = new exceptionMgr(" ");
                $em->logInfo("txabbchmgameplay: Error: No account exists with the given name, deviceid and grade (" . $avatarname . "," . $deviceid . "," . $grade . ")");
            } else {
                ...
                if ($childid == null) {
                    ...
                    $em = new exceptionMgr(" ");
                    $em->logInfo("txabbchmgameplay: Error: Could not retrieve the Child ID for the given name, deviceid and grade (" . $avatarname . "," . $deviceid . "," . $grade . ")");
                } else {
