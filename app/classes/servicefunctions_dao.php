...
class servicefunctions_dao
{
    ...
    function saveNewAccessTokenForChildForDevice($id_child, $deviceid, $access_token, $created_datetime, $app_version_name = null)
    {
    ...
    function updateAppVersionByAccessToken($access_token, $app_version_name)
    {
        ...
        $data = array(
            'app_version_name' => intval($app_version_name)
        );

        $where_condition = "access_token = '" . addslashes($access_token) . "'";
        return $this->dbh->updateRecords('device_accesstoken_tbl', $data, $where_condition);
    }
