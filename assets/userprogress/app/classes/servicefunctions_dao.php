...
class servicefunctions_dao {
    ...
    function getChildUserProgress($childid) {
        ...
        $query = "SELECT ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND id_game like 'NS%' AND id_child = '$childid') AS PNS, 
                ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND id_game like 'NO%' AND id_child = '$childid') AS PNO, 
                ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND (id_game like 'M%' OR id_game like 'SSR%') AND id_child = '$childid') AS PM,
                ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND id_game like 'SG%' AND id_child = '$childid') AS PSG,
                ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND id_game like 'DH%' AND id_child = '$childid') AS PDH,
                ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND (id_game like 'NSF%' OR id_game like 'NSD%') AND id_child = '$childid') AS PNSF,
                ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND id_game like 'NSS%' AND id_child = '$childid') AS PNSS,
                ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND id_game like 'NSC%' AND id_child = '$childid') AS PNSC,
                ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND id_game like 'NSPV%' AND id_child = '$childid') AS PNSPV,
                ...
                ( SELECT COUNT(DISTINCT(id_game)) FROM game_play_tbl WHERE EXISTS (SELECT 1 FROM game_play_detail_tbl WHERE game_play_detail_tbl.id_game_play = game_play_tbl.id_game_play) AND (id_game like 'ML%' OR id_game like 'SSR%') AND id_child = '$childid') AS PML,
        ...
        $query .= "( SELECT SUM(time2answer) FROM `game_play_detail_tbl` WHERE id_child = '$childid') AS PMST,
                ...
                ( SELECT SUM(time2answer) FROM `game_play_detail_tbl` WHERE id_child = '$childid' AND (id_question like 'M%' OR id_question like 'SSR%')) AS PMMST,
    ...
    private function getChildUserProgressObject($arrData) {
        ...
        $objGameplay->setPMNSST($arrData['PMNSST']);
        $objGameplay->setCMNSST($arrData['CMNSST']);

        $objGameplay->setPMMST($arrData['PMMST']);
        $objGameplay->setCMMST($arrData['CMMST']);

        $objGameplay->setPMNOST($arrData['PMNOST']);
        $objGameplay->setCMNOST($arrData['CMNOST']);

        $objGameplay->setPNS($arrData['PNS']);
        $objGameplay->setPNO($arrData['PNO']);
        $objGameplay->setPM($arrData['PM']);
        $objGameplay->setPSG($arrData['PSG']);
        $objGameplay->setPDH($arrData['PDH']);
        $objGameplay->setPNSN($arrData['PNSN']);
        $objGameplay->setPNSF($arrData['PNSF']);
        $objGameplay->setPNSS($arrData['PNSS']);
        $objGameplay->setPNSC($arrData['PNSC']);
        $objGameplay->setPNSPV($arrData['PNSPV']);
        $objGameplay->setPML($arrData['PML']);
