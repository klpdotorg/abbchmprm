...
function login($name, $deviceid, $grade)
{
    $servicefunctions_dao = new servicefunctions_dao();
    $childid = $servicefunctions_dao->getChildIdByNameDeviceAndGrade($name, $deviceid, $grade);
    if ($childid == null)
        return false;
    else
        return $childid;
...
{
    $servicefunctions_dao = new servicefunctions_dao();
    return $servicefunctions_dao->getChildIdByNameDeviceAndGrade($name, $deviceid, $grade);
}

function getAccessTokenForChildForDeviceAndGrade($childname, $deviceid, $grade)
{
    $servicefunctions_dao = new servicefunctions_dao();
    return $servicefunctions_dao->getAccessTokenForChildForDeviceAndGrade($childname, $deviceid, $grade);
}
